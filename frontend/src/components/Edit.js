                ...
                <div className="container-fluid mt-4">
                    <Container fluid="md" style={{backgroundColor: 'rgba(255, 255, 255, 0.8)', width: '60rem' }}>
                        <Form>
                            ...
                            <Form.Check inline label="Male" name="male" type="checkbox" id={`inline-checkbox-1`} onChange={this.handleCheckGender.bind(this)}/>
                            <Form.Check inline label="Female" name="female" type="checkbox" id={`inline-checkbox-2`} onChange={this.handleCheckGender.bind(this)}/>
                            </div>

                            <Form.Group>
                                <Form.Label>Height</Form.Label>
                                <Form.Control type="text" name="height" placeholder="Height" value={height} onChange={this.changeHandler}/>
                            </Form.Group>

                            <Form.Group>
                                <Form.Label>Weight</Form.Label>
                                <Form.Control type="text" name="weight" placeholder="Weight" value={weight} onChange={this.changeHandler}/>
                            </Form.Group>

                            <Form.Group>
                                <Form.Label>Dieting Status</Form.Label>
                                <Form.Control type="text" name="dieting_status" placeholder="Dieting Status" value={dieting_status} onChange={this.changeHandler}/>
                            </Form.Group>
