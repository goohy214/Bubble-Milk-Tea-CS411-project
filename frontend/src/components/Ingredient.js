                ...
                <Container fluid="md" style={{backgroundColor: 'rgba(255, 255, 255, 0.8)', width: '60rem' }}>
                    <Form>
                        <Form.Group>
                            ...
                            <Form.Control type="text" name="ingredient" placeholder="Enter ingredient name" value={ingredient} onChange={this.changeHandler}/>
                        </Form.Group>

                        <Form.Group>
                            <Form.Label>Calorie</Form.Label>
                            <Form.Control type="text" name="calorie" placeholder="Enter calorie" value={calorie} onChange={this.changeHandler}/>
                        </Form.Group>
